...
## Summary of Darknet Diaries Episode 111 : 
"Zeus" (Infosec Scene) Online Banking and Fraud: The episode details the rise of online banking and how it became a target for cybercriminals. As banks moved online, they became vulnerable to attacks, with millions of bank accounts just a login screen away from being accessed by hackers. The core of the episode is the Zeus banking Trojan, developed by a Russian hacker known as Slavik. This malware was designed to steal banking credentials and funds from users' accounts. It evolved over time, becoming one of the most sophisticated and widespread pieces of malware.  Zeus started as WSNPoem and evolved into different versions, ultimately becoming Zeus, which could also turn infected computers into botnets. These botnets were then used for further criminal activities. The malware was not just used by its creator but also sold as a toolkit to other criminals. The FBI conducted a significant investigation into Zeus, eventually identifying the creator, Evgeniy Bogachev, though he remains at large in Russia. Despite several takedown attempts, the malware continued to evolve and remain a major threat. Zeus infected hundreds of thousands of computers and was responsible for stealing over $100 million from victims, mainly by targeting bank customers rather than the banks themselves. It set the standard for what banking malware could achieve and left a lasting impact on the cybersecurity landscape.
